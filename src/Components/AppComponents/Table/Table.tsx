    ...
    >
        ...
        </div>
        {
            ...
            <div className='relative flex-1 bg-CustomBrand-300 p-[4px] flex flex-col gap-y-[7px] shadow-table'>
                ...
                <div className='font-opensans font-normal text-[10px] leading-[16.34px] text-white'>
                    {time}
                </div>
            </div>
            :<div className='relative flex-1 bg-[#EBF3FE] p-[4px] flex flex-col gap-y-[7px] shadow-table'>
                <div className='absolute top-[4px] right-[4px] rounded-[14px] w-[14px] bg-[#FFFFFF] h-[14px] flex justify-center items-center'>
                ...
                <div className='font-opensans font-normal text-[10px] leading-[16.34px] text-CustomText-200'>
                    {time}
                </div>
            </div>
        }
